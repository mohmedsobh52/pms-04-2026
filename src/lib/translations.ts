export const translations = {
  en: {
    ...
    addCredits: "Please add credits or configure OpenAI API key in Settings → Secrets",
    rateLimitExceeded: "Rate limit exceeded",
    tryAgainLater: "Please try again later",
    aiSwitchedToOpenAI: "Switched to OpenAI",
    aiSwitchedToOpenAIDesc: "Lovable AI credits exhausted. Using OpenAI as fallback.",
    configureOpenAIKey: "Configure OpenAI Key",
  ...
  ar: {
    ...
    aiCreditsExhausted: "نفد رصيد الذكاء الاصطناعي",
    addCredits: "يرجى إضافة رصيد أو إعداد مفتاح OpenAI في الإعدادات ← الأسرار",
    rateLimitExceeded: "تم تجاوز حد الطلبات",
    tryAgainLater: "يرجى المحاولة مرة أخرى بعد قليل",
    aiSwitchedToOpenAI: "تم التحويل إلى OpenAI",
    aiSwitchedToOpenAIDesc: "نفد رصيد Lovable AI. يتم استخدام OpenAI كبديل.",
    configureOpenAIKey: "إعداد مفتاح OpenAI",
