...
export function ComprehensiveReport({
  ...
  const generateComprehensiveReport = async () => {
    ...
    try {
      ...
      doc.setFontSize(8);
      doc.setTextColor(100, 116, 139);
      doc.text("BOQ Analyzer - Comprehensive Report", pageWidth / 2, pageHeight - 8, { align: 'center' });
      ...
      doc.text("This comprehensive report was generated by BOQ Analyzer", pageWidth / 2, pageHeight / 2, { align: 'center' });
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <p className="text-sm text-muted-foreground">
          إنشاء تقرير PDF شامل يتضمن جميع البيانات والتحليلات:
        </p>
        
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
          <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/50">
            <Package className="w-4 h-4 text-primary" />
            <span className="text-xs">جدول الكميات</span>
          </div>
          <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/50">
            <Layers className="w-4 h-4 text-purple-500" />
            <span className="text-xs">هيكل العمل WBS</span>
          </div>
          <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/50">
            <DollarSign className="w-4 h-4 text-amber-500" />
            <span className="text-xs">تحليل التكاليف</span>
          </div>
          <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/50">
            <BarChart3 className="w-4 h-4 text-green-500" />
            <span className="text-xs">الرسوم البيانية</span>
          </div>
          <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/50">
