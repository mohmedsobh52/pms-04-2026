...
function EditableQuantityComponent({ value, onSave, className, disabled }: EditableQuantityProps) {
...
export const EditableQuantity = memo(EditableQuantityComponent, (prev, next) =>
