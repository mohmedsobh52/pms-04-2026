...
export const CLAIMS_SECTIONS = [
  ...
  { to: "/reports/evm-monthly", ar: "القيمة المكتسبة الشهرية", en: "Monthly EVM" },
  { to: "/budgeting/unified", ar: "الميزانية الموحدة", en: "Unified budget" },
  { to: "/payroll", ar: "المرتبات", en: "Payroll" },
  { to: "/claims/payroll", ar: "المطالبات مقابل المرتبات", en: "Claims vs payroll" },
