...
export default function TenderSummaryPage() {
  ...
  return (
    <AppShell>
      {/* Page action bar */}
      <div className="sticky top-14 z-30 -mx-2 mb-4 rounded-lg border bg-card/70 px-3 py-2 backdrop-blur-sm">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-2 min-w-0">
            ...
            >
              ...
              <span className="hidden sm:inline">{isArabic ? "رجوع" : "Back"}</span>
            </Button>
